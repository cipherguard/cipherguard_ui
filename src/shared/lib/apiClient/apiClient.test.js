...
describe("Unit testing apiClient with mocked fetch", () => {
  ...
  each([
    ...
    {url: 'https://cipherguard.github.io', error: assertUrlInvalidError},
  ...
  each([
    {url: new URL("https://cipherguard.github.io")},
    {url: new URL("https://cipherguard.github.io/sub-folder/")},
  ...
  each([
    {id: "https://cipherguard.github.io"},
    {id: uuid()},
    {id: "me"},
    {id: "test.json"},
