...
const CIPHERGUARD_GETTING_STARTED_URL = "https://cipherguard.github.io/start";
...
class ExtQuickAccess extends React.Component {
  ...
  async getResourceTypes() {
    const resourceTypes = await this.props.port.request("cipherguard.resource-type.get-or-find-all");
